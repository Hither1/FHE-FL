...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        Decryptor_MK(const SEALContext &context, const SecretKey &secret_key);
    ...
    private:
        ...
        Decryptor_MK(const Decryptor_MK &copy) = delete;

        Decryptor_MK(Decryptor_MK &&source) = delete;

        Decryptor_MK &operator=(const Decryptor_MK &assign) = delete;

        Decryptor_MK &operator=(Decryptor_MK &&assign) = delete;
